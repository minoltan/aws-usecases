...
declare const UpdateCapacityReservationCommand_base: {
    new (input: UpdateCapacityReservationCommandInput): import("@smithy/core/client").CommandImpl<UpdateCapacityReservationCommandInput, UpdateCapacityReservationCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateCapacityReservationCommandInput): import("@smithy/core/client").CommandImpl<UpdateCapacityReservationCommandInput, UpdateCapacityReservationCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
