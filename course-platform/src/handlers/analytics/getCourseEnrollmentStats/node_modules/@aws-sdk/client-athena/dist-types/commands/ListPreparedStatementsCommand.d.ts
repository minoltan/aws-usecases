...
declare const ListPreparedStatementsCommand_base: {
    new (input: ListPreparedStatementsCommandInput): import("@smithy/core/client").CommandImpl<ListPreparedStatementsCommandInput, ListPreparedStatementsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListPreparedStatementsCommandInput): import("@smithy/core/client").CommandImpl<ListPreparedStatementsCommandInput, ListPreparedStatementsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
