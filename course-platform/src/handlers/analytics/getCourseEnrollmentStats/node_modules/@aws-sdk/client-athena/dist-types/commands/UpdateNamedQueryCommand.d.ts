...
declare const UpdateNamedQueryCommand_base: {
    new (input: UpdateNamedQueryCommandInput): import("@smithy/core/client").CommandImpl<UpdateNamedQueryCommandInput, UpdateNamedQueryCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateNamedQueryCommandInput): import("@smithy/core/client").CommandImpl<UpdateNamedQueryCommandInput, UpdateNamedQueryCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
