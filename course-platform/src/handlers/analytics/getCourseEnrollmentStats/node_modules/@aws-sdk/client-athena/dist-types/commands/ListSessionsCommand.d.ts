...
declare const ListSessionsCommand_base: {
    new (input: ListSessionsCommandInput): import("@smithy/core/client").CommandImpl<ListSessionsCommandInput, ListSessionsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListSessionsCommandInput): import("@smithy/core/client").CommandImpl<ListSessionsCommandInput, ListSessionsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
