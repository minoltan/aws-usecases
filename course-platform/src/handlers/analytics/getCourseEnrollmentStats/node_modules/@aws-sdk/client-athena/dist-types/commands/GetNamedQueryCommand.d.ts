...
import type { GetNamedQueryInput, GetNamedQueryOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const GetNamedQueryCommand_base: {
    new (input: GetNamedQueryCommandInput): import("@smithy/core/client").CommandImpl<GetNamedQueryCommandInput, GetNamedQueryCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetNamedQueryCommandInput): import("@smithy/core/client").CommandImpl<GetNamedQueryCommandInput, GetNamedQueryCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
