...
declare const ListTableMetadataCommand_base: {
    new (input: ListTableMetadataCommandInput): import("@smithy/core/client").CommandImpl<ListTableMetadataCommandInput, ListTableMetadataCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListTableMetadataCommandInput): import("@smithy/core/client").CommandImpl<ListTableMetadataCommandInput, ListTableMetadataCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
