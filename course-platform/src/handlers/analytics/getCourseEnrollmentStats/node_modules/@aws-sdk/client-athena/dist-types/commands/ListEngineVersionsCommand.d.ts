...
declare const ListEngineVersionsCommand_base: {
    new (input: ListEngineVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListEngineVersionsCommandInput, ListEngineVersionsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListEngineVersionsCommandInput]): import("@smithy/core/client").CommandImpl<ListEngineVersionsCommandInput, ListEngineVersionsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
