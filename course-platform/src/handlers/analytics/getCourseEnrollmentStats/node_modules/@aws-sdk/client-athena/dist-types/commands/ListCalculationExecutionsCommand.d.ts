...
declare const ListCalculationExecutionsCommand_base: {
    new (input: ListCalculationExecutionsCommandInput): import("@smithy/core/client").CommandImpl<ListCalculationExecutionsCommandInput, ListCalculationExecutionsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListCalculationExecutionsCommandInput): import("@smithy/core/client").CommandImpl<ListCalculationExecutionsCommandInput, ListCalculationExecutionsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
