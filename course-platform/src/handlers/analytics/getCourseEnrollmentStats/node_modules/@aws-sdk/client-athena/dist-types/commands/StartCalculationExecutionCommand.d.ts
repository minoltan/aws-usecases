...
declare const StartCalculationExecutionCommand_base: {
    new (input: StartCalculationExecutionCommandInput): import("@smithy/core/client").CommandImpl<StartCalculationExecutionCommandInput, StartCalculationExecutionCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartCalculationExecutionCommandInput): import("@smithy/core/client").CommandImpl<StartCalculationExecutionCommandInput, StartCalculationExecutionCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
