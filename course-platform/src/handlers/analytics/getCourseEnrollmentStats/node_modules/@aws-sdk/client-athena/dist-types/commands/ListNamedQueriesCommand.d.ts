...
declare const ListNamedQueriesCommand_base: {
    new (input: ListNamedQueriesCommandInput): import("@smithy/core/client").CommandImpl<ListNamedQueriesCommandInput, ListNamedQueriesCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListNamedQueriesCommandInput]): import("@smithy/core/client").CommandImpl<ListNamedQueriesCommandInput, ListNamedQueriesCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
