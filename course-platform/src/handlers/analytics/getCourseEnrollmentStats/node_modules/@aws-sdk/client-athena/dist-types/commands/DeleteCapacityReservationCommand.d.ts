...
declare const DeleteCapacityReservationCommand_base: {
    new (input: DeleteCapacityReservationCommandInput): import("@smithy/core/client").CommandImpl<DeleteCapacityReservationCommandInput, DeleteCapacityReservationCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCapacityReservationCommandInput): import("@smithy/core/client").CommandImpl<DeleteCapacityReservationCommandInput, DeleteCapacityReservationCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
