...
import type { ListNotebookMetadataInput, ListNotebookMetadataOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const ListNotebookMetadataCommand_base: {
    new (input: ListNotebookMetadataCommandInput): import("@smithy/core/client").CommandImpl<ListNotebookMetadataCommandInput, ListNotebookMetadataCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListNotebookMetadataCommandInput): import("@smithy/core/client").CommandImpl<ListNotebookMetadataCommandInput, ListNotebookMetadataCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
