...
declare const GetCalculationExecutionStatusCommand_base: {
    new (input: GetCalculationExecutionStatusCommandInput): import("@smithy/core/client").CommandImpl<GetCalculationExecutionStatusCommandInput, GetCalculationExecutionStatusCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCalculationExecutionStatusCommandInput): import("@smithy/core/client").CommandImpl<GetCalculationExecutionStatusCommandInput, GetCalculationExecutionStatusCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
