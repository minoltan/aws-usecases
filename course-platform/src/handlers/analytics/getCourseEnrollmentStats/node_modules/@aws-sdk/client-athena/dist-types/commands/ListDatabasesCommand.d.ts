...
declare const ListDatabasesCommand_base: {
    new (input: ListDatabasesCommandInput): import("@smithy/core/client").CommandImpl<ListDatabasesCommandInput, ListDatabasesCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDatabasesCommandInput): import("@smithy/core/client").CommandImpl<ListDatabasesCommandInput, ListDatabasesCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
