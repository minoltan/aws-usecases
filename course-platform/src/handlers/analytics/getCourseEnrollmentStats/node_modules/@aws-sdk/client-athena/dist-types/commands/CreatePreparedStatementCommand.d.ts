...
declare const CreatePreparedStatementCommand_base: {
    new (input: CreatePreparedStatementCommandInput): import("@smithy/core/client").CommandImpl<CreatePreparedStatementCommandInput, CreatePreparedStatementCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePreparedStatementCommandInput): import("@smithy/core/client").CommandImpl<CreatePreparedStatementCommandInput, CreatePreparedStatementCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
