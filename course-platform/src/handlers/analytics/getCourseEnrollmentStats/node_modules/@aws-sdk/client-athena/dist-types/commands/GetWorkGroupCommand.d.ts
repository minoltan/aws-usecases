...
import type { GetWorkGroupInput, GetWorkGroupOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const GetWorkGroupCommand_base: {
    new (input: GetWorkGroupCommandInput): import("@smithy/core/client").CommandImpl<GetWorkGroupCommandInput, GetWorkGroupCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetWorkGroupCommandInput): import("@smithy/core/client").CommandImpl<GetWorkGroupCommandInput, GetWorkGroupCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
