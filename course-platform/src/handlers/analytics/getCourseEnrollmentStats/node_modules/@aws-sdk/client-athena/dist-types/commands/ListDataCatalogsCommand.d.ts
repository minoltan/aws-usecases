...
import type { ListDataCatalogsInput, ListDataCatalogsOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const ListDataCatalogsCommand_base: {
    new (input: ListDataCatalogsCommandInput): import("@smithy/core/client").CommandImpl<ListDataCatalogsCommandInput, ListDataCatalogsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDataCatalogsCommandInput]): import("@smithy/core/client").CommandImpl<ListDataCatalogsCommandInput, ListDataCatalogsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
