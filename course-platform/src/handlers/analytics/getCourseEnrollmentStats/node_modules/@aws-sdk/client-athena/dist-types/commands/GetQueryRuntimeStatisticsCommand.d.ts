...
import type { GetQueryRuntimeStatisticsInput, GetQueryRuntimeStatisticsOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const GetQueryRuntimeStatisticsCommand_base: {
    new (input: GetQueryRuntimeStatisticsCommandInput): import("@smithy/core/client").CommandImpl<GetQueryRuntimeStatisticsCommandInput, GetQueryRuntimeStatisticsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetQueryRuntimeStatisticsCommandInput): import("@smithy/core/client").CommandImpl<GetQueryRuntimeStatisticsCommandInput, GetQueryRuntimeStatisticsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
