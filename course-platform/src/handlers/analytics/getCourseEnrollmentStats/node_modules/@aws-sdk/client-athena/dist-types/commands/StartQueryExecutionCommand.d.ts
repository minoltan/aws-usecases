...
import type { StartQueryExecutionInput, StartQueryExecutionOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const StartQueryExecutionCommand_base: {
    new (input: StartQueryExecutionCommandInput): import("@smithy/core/client").CommandImpl<StartQueryExecutionCommandInput, StartQueryExecutionCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartQueryExecutionCommandInput): import("@smithy/core/client").CommandImpl<StartQueryExecutionCommandInput, StartQueryExecutionCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
