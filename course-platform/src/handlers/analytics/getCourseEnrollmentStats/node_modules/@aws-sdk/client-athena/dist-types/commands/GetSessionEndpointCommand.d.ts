...
declare const GetSessionEndpointCommand_base: {
    new (input: GetSessionEndpointCommandInput): import("@smithy/core/client").CommandImpl<GetSessionEndpointCommandInput, GetSessionEndpointCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSessionEndpointCommandInput): import("@smithy/core/client").CommandImpl<GetSessionEndpointCommandInput, GetSessionEndpointCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
