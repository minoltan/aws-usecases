...
declare const CreateCapacityReservationCommand_base: {
    new (input: CreateCapacityReservationCommandInput): import("@smithy/core/client").CommandImpl<CreateCapacityReservationCommandInput, CreateCapacityReservationCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCapacityReservationCommandInput): import("@smithy/core/client").CommandImpl<CreateCapacityReservationCommandInput, CreateCapacityReservationCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
