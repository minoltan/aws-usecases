...
import type { UpdateWorkGroupInput, UpdateWorkGroupOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateWorkGroupCommand_base: {
    new (input: UpdateWorkGroupCommandInput): import("@smithy/core/client").CommandImpl<UpdateWorkGroupCommandInput, UpdateWorkGroupCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateWorkGroupCommandInput): import("@smithy/core/client").CommandImpl<UpdateWorkGroupCommandInput, UpdateWorkGroupCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
