...
import type { ListCapacityReservationsInput, ListCapacityReservationsOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const ListCapacityReservationsCommand_base: {
    new (input: ListCapacityReservationsCommandInput): import("@smithy/core/client").CommandImpl<ListCapacityReservationsCommandInput, ListCapacityReservationsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCapacityReservationsCommandInput]): import("@smithy/core/client").CommandImpl<ListCapacityReservationsCommandInput, ListCapacityReservationsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
