...
declare const CreatePresignedNotebookUrlCommand_base: {
    new (input: CreatePresignedNotebookUrlCommandInput): import("@smithy/core/client").CommandImpl<CreatePresignedNotebookUrlCommandInput, CreatePresignedNotebookUrlCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePresignedNotebookUrlCommandInput): import("@smithy/core/client").CommandImpl<CreatePresignedNotebookUrlCommandInput, CreatePresignedNotebookUrlCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
