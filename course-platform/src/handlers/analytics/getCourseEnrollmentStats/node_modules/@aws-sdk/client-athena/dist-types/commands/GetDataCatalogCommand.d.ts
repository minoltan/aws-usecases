...
declare const GetDataCatalogCommand_base: {
    new (input: GetDataCatalogCommandInput): import("@smithy/core/client").CommandImpl<GetDataCatalogCommandInput, GetDataCatalogCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDataCatalogCommandInput): import("@smithy/core/client").CommandImpl<GetDataCatalogCommandInput, GetDataCatalogCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
