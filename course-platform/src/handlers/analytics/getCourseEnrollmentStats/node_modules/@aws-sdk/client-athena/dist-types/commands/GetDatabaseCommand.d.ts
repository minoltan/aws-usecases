...
declare const GetDatabaseCommand_base: {
    new (input: GetDatabaseCommandInput): import("@smithy/core/client").CommandImpl<GetDatabaseCommandInput, GetDatabaseCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDatabaseCommandInput): import("@smithy/core/client").CommandImpl<GetDatabaseCommandInput, GetDatabaseCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
