...
declare const DeleteDataCatalogCommand_base: {
    new (input: DeleteDataCatalogCommandInput): import("@smithy/core/client").CommandImpl<DeleteDataCatalogCommandInput, DeleteDataCatalogCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDataCatalogCommandInput): import("@smithy/core/client").CommandImpl<DeleteDataCatalogCommandInput, DeleteDataCatalogCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
