...
import type { StopCalculationExecutionRequest, StopCalculationExecutionResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const StopCalculationExecutionCommand_base: {
    new (input: StopCalculationExecutionCommandInput): import("@smithy/core/client").CommandImpl<StopCalculationExecutionCommandInput, StopCalculationExecutionCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopCalculationExecutionCommandInput): import("@smithy/core/client").CommandImpl<StopCalculationExecutionCommandInput, StopCalculationExecutionCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
