...
declare const GetCalculationExecutionCodeCommand_base: {
    new (input: GetCalculationExecutionCodeCommandInput): import("@smithy/core/client").CommandImpl<GetCalculationExecutionCodeCommandInput, GetCalculationExecutionCodeCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCalculationExecutionCodeCommandInput): import("@smithy/core/client").CommandImpl<GetCalculationExecutionCodeCommandInput, GetCalculationExecutionCodeCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
