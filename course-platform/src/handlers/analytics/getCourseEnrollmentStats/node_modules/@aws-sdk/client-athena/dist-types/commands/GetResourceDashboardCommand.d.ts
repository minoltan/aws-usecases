...
declare const GetResourceDashboardCommand_base: {
    new (input: GetResourceDashboardCommandInput): import("@smithy/core/client").CommandImpl<GetResourceDashboardCommandInput, GetResourceDashboardCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetResourceDashboardCommandInput): import("@smithy/core/client").CommandImpl<GetResourceDashboardCommandInput, GetResourceDashboardCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
