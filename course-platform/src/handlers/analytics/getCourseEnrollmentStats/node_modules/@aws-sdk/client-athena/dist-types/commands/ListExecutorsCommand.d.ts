...
declare const ListExecutorsCommand_base: {
    new (input: ListExecutorsCommandInput): import("@smithy/core/client").CommandImpl<ListExecutorsCommandInput, ListExecutorsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListExecutorsCommandInput): import("@smithy/core/client").CommandImpl<ListExecutorsCommandInput, ListExecutorsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
