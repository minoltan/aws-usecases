...
import type { UpdateNotebookMetadataInput, UpdateNotebookMetadataOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateNotebookMetadataCommand_base: {
    new (input: UpdateNotebookMetadataCommandInput): import("@smithy/core/client").CommandImpl<UpdateNotebookMetadataCommandInput, UpdateNotebookMetadataCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateNotebookMetadataCommandInput): import("@smithy/core/client").CommandImpl<UpdateNotebookMetadataCommandInput, UpdateNotebookMetadataCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
