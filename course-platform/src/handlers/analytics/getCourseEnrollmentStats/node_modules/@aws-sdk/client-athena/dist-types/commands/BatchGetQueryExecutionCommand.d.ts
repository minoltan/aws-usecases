...
declare const BatchGetQueryExecutionCommand_base: {
    new (input: BatchGetQueryExecutionCommandInput): import("@smithy/core/client").CommandImpl<BatchGetQueryExecutionCommandInput, BatchGetQueryExecutionCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchGetQueryExecutionCommandInput): import("@smithy/core/client").CommandImpl<BatchGetQueryExecutionCommandInput, BatchGetQueryExecutionCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
