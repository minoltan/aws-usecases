...
import type { PutCapacityAssignmentConfigurationInput, PutCapacityAssignmentConfigurationOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const PutCapacityAssignmentConfigurationCommand_base: {
    new (input: PutCapacityAssignmentConfigurationCommandInput): import("@smithy/core/client").CommandImpl<PutCapacityAssignmentConfigurationCommandInput, PutCapacityAssignmentConfigurationCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutCapacityAssignmentConfigurationCommandInput): import("@smithy/core/client").CommandImpl<PutCapacityAssignmentConfigurationCommandInput, PutCapacityAssignmentConfigurationCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
