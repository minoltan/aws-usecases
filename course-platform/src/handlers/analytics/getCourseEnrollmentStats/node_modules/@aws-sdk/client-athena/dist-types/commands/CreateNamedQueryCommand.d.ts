...
declare const CreateNamedQueryCommand_base: {
    new (input: CreateNamedQueryCommandInput): import("@smithy/core/client").CommandImpl<CreateNamedQueryCommandInput, CreateNamedQueryCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateNamedQueryCommandInput): import("@smithy/core/client").CommandImpl<CreateNamedQueryCommandInput, CreateNamedQueryCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
