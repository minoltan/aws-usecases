...
declare const ListQueryExecutionsCommand_base: {
    new (input: ListQueryExecutionsCommandInput): import("@smithy/core/client").CommandImpl<ListQueryExecutionsCommandInput, ListQueryExecutionsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListQueryExecutionsCommandInput]): import("@smithy/core/client").CommandImpl<ListQueryExecutionsCommandInput, ListQueryExecutionsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
