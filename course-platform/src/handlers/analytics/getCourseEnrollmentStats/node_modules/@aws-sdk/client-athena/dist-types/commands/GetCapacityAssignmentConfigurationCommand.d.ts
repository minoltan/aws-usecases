...
declare const GetCapacityAssignmentConfigurationCommand_base: {
    new (input: GetCapacityAssignmentConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetCapacityAssignmentConfigurationCommandInput, GetCapacityAssignmentConfigurationCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCapacityAssignmentConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetCapacityAssignmentConfigurationCommandInput, GetCapacityAssignmentConfigurationCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
