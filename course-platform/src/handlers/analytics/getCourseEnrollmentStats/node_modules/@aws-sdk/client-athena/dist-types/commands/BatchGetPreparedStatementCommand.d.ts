...
declare const BatchGetPreparedStatementCommand_base: {
    new (input: BatchGetPreparedStatementCommandInput): import("@smithy/core/client").CommandImpl<BatchGetPreparedStatementCommandInput, BatchGetPreparedStatementCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchGetPreparedStatementCommandInput): import("@smithy/core/client").CommandImpl<BatchGetPreparedStatementCommandInput, BatchGetPreparedStatementCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
