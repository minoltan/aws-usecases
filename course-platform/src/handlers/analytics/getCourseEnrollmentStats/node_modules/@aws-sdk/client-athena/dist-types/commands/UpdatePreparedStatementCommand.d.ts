...
import type { UpdatePreparedStatementInput, UpdatePreparedStatementOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdatePreparedStatementCommand_base: {
    new (input: UpdatePreparedStatementCommandInput): import("@smithy/core/client").CommandImpl<UpdatePreparedStatementCommandInput, UpdatePreparedStatementCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePreparedStatementCommandInput): import("@smithy/core/client").CommandImpl<UpdatePreparedStatementCommandInput, UpdatePreparedStatementCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
