...
declare const BatchGetNamedQueryCommand_base: {
    new (input: BatchGetNamedQueryCommandInput): import("@smithy/core/client").CommandImpl<BatchGetNamedQueryCommandInput, BatchGetNamedQueryCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchGetNamedQueryCommandInput): import("@smithy/core/client").CommandImpl<BatchGetNamedQueryCommandInput, BatchGetNamedQueryCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
