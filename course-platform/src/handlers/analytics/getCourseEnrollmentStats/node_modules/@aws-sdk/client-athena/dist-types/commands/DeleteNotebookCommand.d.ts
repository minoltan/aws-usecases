...
declare const DeleteNotebookCommand_base: {
    new (input: DeleteNotebookCommandInput): import("@smithy/core/client").CommandImpl<DeleteNotebookCommandInput, DeleteNotebookCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteNotebookCommandInput): import("@smithy/core/client").CommandImpl<DeleteNotebookCommandInput, DeleteNotebookCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
