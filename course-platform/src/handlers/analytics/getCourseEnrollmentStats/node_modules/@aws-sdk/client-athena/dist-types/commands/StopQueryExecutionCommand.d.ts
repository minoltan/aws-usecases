...
import type { StopQueryExecutionInput, StopQueryExecutionOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const StopQueryExecutionCommand_base: {
    new (input: StopQueryExecutionCommandInput): import("@smithy/core/client").CommandImpl<StopQueryExecutionCommandInput, StopQueryExecutionCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [StopQueryExecutionCommandInput]): import("@smithy/core/client").CommandImpl<StopQueryExecutionCommandInput, StopQueryExecutionCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
