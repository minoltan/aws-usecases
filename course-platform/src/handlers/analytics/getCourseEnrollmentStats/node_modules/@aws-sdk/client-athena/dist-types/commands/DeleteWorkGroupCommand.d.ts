...
declare const DeleteWorkGroupCommand_base: {
    new (input: DeleteWorkGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteWorkGroupCommandInput, DeleteWorkGroupCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteWorkGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteWorkGroupCommandInput, DeleteWorkGroupCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
