...
declare const GetSessionStatusCommand_base: {
    new (input: GetSessionStatusCommandInput): import("@smithy/core/client").CommandImpl<GetSessionStatusCommandInput, GetSessionStatusCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSessionStatusCommandInput): import("@smithy/core/client").CommandImpl<GetSessionStatusCommandInput, GetSessionStatusCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
