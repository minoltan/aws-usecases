...
declare const CreateNotebookCommand_base: {
    new (input: CreateNotebookCommandInput): import("@smithy/core/client").CommandImpl<CreateNotebookCommandInput, CreateNotebookCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateNotebookCommandInput): import("@smithy/core/client").CommandImpl<CreateNotebookCommandInput, CreateNotebookCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
