...
declare const ExportNotebookCommand_base: {
    new (input: ExportNotebookCommandInput): import("@smithy/core/client").CommandImpl<ExportNotebookCommandInput, ExportNotebookCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ExportNotebookCommandInput): import("@smithy/core/client").CommandImpl<ExportNotebookCommandInput, ExportNotebookCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
