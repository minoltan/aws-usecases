...
declare const GetNotebookMetadataCommand_base: {
    new (input: GetNotebookMetadataCommandInput): import("@smithy/core/client").CommandImpl<GetNotebookMetadataCommandInput, GetNotebookMetadataCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetNotebookMetadataCommandInput): import("@smithy/core/client").CommandImpl<GetNotebookMetadataCommandInput, GetNotebookMetadataCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
