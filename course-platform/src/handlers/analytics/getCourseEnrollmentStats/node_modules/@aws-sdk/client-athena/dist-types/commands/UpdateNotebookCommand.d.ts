...
import type { UpdateNotebookInput, UpdateNotebookOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateNotebookCommand_base: {
    new (input: UpdateNotebookCommandInput): import("@smithy/core/client").CommandImpl<UpdateNotebookCommandInput, UpdateNotebookCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateNotebookCommandInput): import("@smithy/core/client").CommandImpl<UpdateNotebookCommandInput, UpdateNotebookCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
