...
import type { ListApplicationDPUSizesInput, ListApplicationDPUSizesOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const ListApplicationDPUSizesCommand_base: {
    new (input: ListApplicationDPUSizesCommandInput): import("@smithy/core/client").CommandImpl<ListApplicationDPUSizesCommandInput, ListApplicationDPUSizesCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListApplicationDPUSizesCommandInput]): import("@smithy/core/client").CommandImpl<ListApplicationDPUSizesCommandInput, ListApplicationDPUSizesCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
