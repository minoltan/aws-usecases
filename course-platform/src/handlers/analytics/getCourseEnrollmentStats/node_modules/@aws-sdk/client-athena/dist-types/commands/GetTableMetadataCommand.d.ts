...
import type { GetTableMetadataInput, GetTableMetadataOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const GetTableMetadataCommand_base: {
    new (input: GetTableMetadataCommandInput): import("@smithy/core/client").CommandImpl<GetTableMetadataCommandInput, GetTableMetadataCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTableMetadataCommandInput): import("@smithy/core/client").CommandImpl<GetTableMetadataCommandInput, GetTableMetadataCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
