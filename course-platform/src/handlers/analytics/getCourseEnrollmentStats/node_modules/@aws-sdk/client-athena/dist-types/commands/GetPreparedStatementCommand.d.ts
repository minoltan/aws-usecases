...
declare const GetPreparedStatementCommand_base: {
    new (input: GetPreparedStatementCommandInput): import("@smithy/core/client").CommandImpl<GetPreparedStatementCommandInput, GetPreparedStatementCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPreparedStatementCommandInput): import("@smithy/core/client").CommandImpl<GetPreparedStatementCommandInput, GetPreparedStatementCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
