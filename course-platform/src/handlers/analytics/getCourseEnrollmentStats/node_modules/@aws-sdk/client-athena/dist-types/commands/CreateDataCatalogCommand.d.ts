...
declare const CreateDataCatalogCommand_base: {
    new (input: CreateDataCatalogCommandInput): import("@smithy/core/client").CommandImpl<CreateDataCatalogCommandInput, CreateDataCatalogCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDataCatalogCommandInput): import("@smithy/core/client").CommandImpl<CreateDataCatalogCommandInput, CreateDataCatalogCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
