...
declare const DeleteNamedQueryCommand_base: {
    new (input: DeleteNamedQueryCommandInput): import("@smithy/core/client").CommandImpl<DeleteNamedQueryCommandInput, DeleteNamedQueryCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeleteNamedQueryCommandInput]): import("@smithy/core/client").CommandImpl<DeleteNamedQueryCommandInput, DeleteNamedQueryCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
