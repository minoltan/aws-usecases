...
declare const CreateWorkGroupCommand_base: {
    new (input: CreateWorkGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateWorkGroupCommandInput, CreateWorkGroupCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateWorkGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateWorkGroupCommandInput, CreateWorkGroupCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
