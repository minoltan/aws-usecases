...
import type { ImportNotebookInput, ImportNotebookOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const ImportNotebookCommand_base: {
    new (input: ImportNotebookCommandInput): import("@smithy/core/client").CommandImpl<ImportNotebookCommandInput, ImportNotebookCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ImportNotebookCommandInput): import("@smithy/core/client").CommandImpl<ImportNotebookCommandInput, ImportNotebookCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
