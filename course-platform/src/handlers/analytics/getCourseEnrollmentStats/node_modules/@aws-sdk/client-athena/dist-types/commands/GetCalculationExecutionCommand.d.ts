...
declare const GetCalculationExecutionCommand_base: {
    new (input: GetCalculationExecutionCommandInput): import("@smithy/core/client").CommandImpl<GetCalculationExecutionCommandInput, GetCalculationExecutionCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCalculationExecutionCommandInput): import("@smithy/core/client").CommandImpl<GetCalculationExecutionCommandInput, GetCalculationExecutionCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
