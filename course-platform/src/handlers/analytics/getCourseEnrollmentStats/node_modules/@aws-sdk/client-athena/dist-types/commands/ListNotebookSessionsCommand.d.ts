...
declare const ListNotebookSessionsCommand_base: {
    new (input: ListNotebookSessionsCommandInput): import("@smithy/core/client").CommandImpl<ListNotebookSessionsCommandInput, ListNotebookSessionsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListNotebookSessionsCommandInput): import("@smithy/core/client").CommandImpl<ListNotebookSessionsCommandInput, ListNotebookSessionsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
