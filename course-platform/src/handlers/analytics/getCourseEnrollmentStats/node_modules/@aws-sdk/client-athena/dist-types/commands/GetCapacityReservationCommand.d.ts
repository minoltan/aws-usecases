...
declare const GetCapacityReservationCommand_base: {
    new (input: GetCapacityReservationCommandInput): import("@smithy/core/client").CommandImpl<GetCapacityReservationCommandInput, GetCapacityReservationCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCapacityReservationCommandInput): import("@smithy/core/client").CommandImpl<GetCapacityReservationCommandInput, GetCapacityReservationCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
