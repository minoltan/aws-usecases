...
declare const UpdateDataCatalogCommand_base: {
    new (input: UpdateDataCatalogCommandInput): import("@smithy/core/client").CommandImpl<UpdateDataCatalogCommandInput, UpdateDataCatalogCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDataCatalogCommandInput): import("@smithy/core/client").CommandImpl<UpdateDataCatalogCommandInput, UpdateDataCatalogCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
