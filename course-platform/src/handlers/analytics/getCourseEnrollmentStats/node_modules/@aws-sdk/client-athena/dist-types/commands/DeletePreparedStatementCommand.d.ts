...
declare const DeletePreparedStatementCommand_base: {
    new (input: DeletePreparedStatementCommandInput): import("@smithy/core/client").CommandImpl<DeletePreparedStatementCommandInput, DeletePreparedStatementCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePreparedStatementCommandInput): import("@smithy/core/client").CommandImpl<DeletePreparedStatementCommandInput, DeletePreparedStatementCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
