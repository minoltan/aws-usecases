...
declare const ListWorkGroupsCommand_base: {
    new (input: ListWorkGroupsCommandInput): import("@smithy/core/client").CommandImpl<ListWorkGroupsCommandInput, ListWorkGroupsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListWorkGroupsCommandInput]): import("@smithy/core/client").CommandImpl<ListWorkGroupsCommandInput, ListWorkGroupsCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
