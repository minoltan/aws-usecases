...
import type { GetQueryExecutionInput, GetQueryExecutionOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const GetQueryExecutionCommand_base: {
    new (input: GetQueryExecutionCommandInput): import("@smithy/core/client").CommandImpl<GetQueryExecutionCommandInput, GetQueryExecutionCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetQueryExecutionCommandInput): import("@smithy/core/client").CommandImpl<GetQueryExecutionCommandInput, GetQueryExecutionCommandOutput, import("..").AthenaClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
