...
declare const GetJobsQueryResultsCommand_base: {
    new (input: GetJobsQueryResultsCommandInput): import("@smithy/core/client").CommandImpl<GetJobsQueryResultsCommandInput, GetJobsQueryResultsCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetJobsQueryResultsCommandInput): import("@smithy/core/client").CommandImpl<GetJobsQueryResultsCommandInput, GetJobsQueryResultsCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
