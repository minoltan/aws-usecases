...
const defaultMediaConvertHttpAuthSchemeParametersProvider = async (config, context, input) => {
    return {
...
const defaultMediaConvertHttpAuthSchemeProvider = (authParameters) => {
    const options = [];
...
const _data = {
    ...
    results: [
        ...
        [h, k],
        ["https://mediaconvert-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", k],
        [a, "FIPS and DualStack are enabled, but this partition does not support one or both"],
        ["https://mediaconvert.{Region}.amazonaws.com", k],
        ["https://mediaconvert-fips.{Region}.{PartitionResult#dnsSuffix}", k],
        [a, "FIPS is enabled but this partition does not support FIPS"],
        ["https://mediaconvert.{Region}.{PartitionResult#dualStackDnsSuffix}", k],
        [a, "DualStack is enabled but this partition does not support DualStack"],
        ["https://subscribe.mediaconvert.cn-northwest-1.amazonaws.com.cn", k],
        ["https://mediaconvert.{Region}.{PartitionResult#dnsSuffix}", k],
...
class MediaConvertServiceException extends ServiceException {
    constructor(options) {
        super(options);
...
var MediaConvertServiceException$ = [-3, _s, "MediaConvertServiceException", 0, [], []];
...
var CmafImageBasedTrickPlayVariant$ = [3, n0, _CIBTPV,
    0,
    [_IC, _TH, _TI, _TW, _THi, _TWi],
    [[0, { [_jN]: _iC }], [1, { [_jN]: _tH }], [1, { [_jN]: _tI }], [1, { [_jN]: _tW }], [1, { [_jN]: _tHi }], [1, { [_jN]: _tWi }]]
];
...
var ContentLightLevel$ = [3, n0, _CLL,
    0,
    [_MCLL, _MFALL],
...
var DashIsoImageBasedTrickPlayVariant$ = [3, n0, _DIIBTPV,
    0,
    [_IC, _TH, _TI, _TW, _THi, _TWi],
    [[0, { [_jN]: _iC }], [1, { [_jN]: _tH }], [1, { [_jN]: _tI }], [1, { [_jN]: _tW }], [1, { [_jN]: _tHi }], [1, { [_jN]: _tWi }]]
];
...
var ElementalInferenceConfiguration$ = [3, n0, _EIC,
    0,
    [_Fe, _Fee],
    [[64 | 0, { [_jN]: _fe }], [() => __listOfElementalInferenceFeed, { [_jN]: _fee }]]
];
var ElementalInferenceFeed$ = [3, n0, _EIF,
    0,
    [_A, _FMS],
    [[0, { [_jN]: _a }], [0, { [_jN]: _fMS }]]
];
...
var HlsImageBasedTrickPlayVariant$ = [3, n0, _HIBTPV,
    0,
    [_IC, _TH, _TI, _TW, _THi, _TWi],
    [[0, { [_jN]: _iC }], [1, { [_jN]: _tH }], [1, { [_jN]: _tI }], [1, { [_jN]: _tW }], [1, { [_jN]: _tHi }], [1, { [_jN]: _tWi }]]
];
...
var MasteringDisplayColorVolume$ = [3, n0, _MDCV,
    0,
...
var MultiViewInput$ = [3, n0, _MVI,
    0,
    [_FI],
    [[0, { [_jN]: _fI }]]
];
var MultiViewSettings$ = [3, n0, _MVS,
    0,
    [_In],
...
const getRuntimeConfig$1 = (config) => {
    return {
        ...
        httpAuthSchemeProvider: config?.httpAuthSchemeProvider ?? defaultMediaConvertHttpAuthSchemeProvider,
...
class MediaConvertClient extends Client {
    config;
    constructor(...[configuration]) {
        ...
        this.middlewareStack.use(getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
            httpAuthSchemeParametersProvider: defaultMediaConvertHttpAuthSchemeParametersProvider,
...
const command = makeBuilder(commonParams, "MediaConvert", "MediaConvertClient", getEndpointPlugin);
const _ep0 = {};
...
class CreatePresetCommand extends command(_ep0, _mw0, "CreatePreset", CreatePreset$) {
}
...
class DeletePresetCommand extends command(_ep0, _mw0, "DeletePreset", DeletePreset$) {
}
...
class GetJobsQueryResultsCommand extends command(_ep0, _mw0, "GetJobsQueryResults", GetJobsQueryResults$) {
}

class GetJobTemplateCommand extends command(_ep0, _mw0, "GetJobTemplate", GetJobTemplate$) {
}

class GetPolicyCommand extends command(_ep0, _mw0, "GetPolicy", GetPolicy$) {
}

class GetPresetCommand extends command(_ep0, _mw0, "GetPreset", GetPreset$) {
}
...
class ListPresetsCommand extends command(_ep0, _mw0, "ListPresets", ListPresets$) {
}
...
class ProbeCommand extends command(_ep0, _mw0, "Probe", Probe$) {
}
...
class StartJobsQueryCommand extends command(_ep0, _mw0, "StartJobsQuery", StartJobsQuery$) {
}
...
class UpdateJobTemplateCommand extends command(_ep0, _mw0, "UpdateJobTemplate", UpdateJobTemplate$) {
}

class UpdatePresetCommand extends command(_ep0, _mw0, "UpdatePreset", UpdatePreset$) {
}

class UpdateQueueCommand extends command(_ep0, _mw0, "UpdateQueue", UpdateQueue$) {
}

const paginateDescribeEndpoints = createPaginator(MediaConvertClient, DescribeEndpointsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListJobs = createPaginator(MediaConvertClient, ListJobsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListJobTemplates = createPaginator(MediaConvertClient, ListJobTemplatesCommand, "NextToken", "NextToken", "MaxResults");

const paginateListPresets = createPaginator(MediaConvertClient, ListPresetsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListQueues = createPaginator(MediaConvertClient, ListQueuesCommand, "NextToken", "NextToken", "MaxResults");

const paginateListVersions = createPaginator(MediaConvertClient, ListVersionsCommand, "NextToken", "NextToken", "MaxResults");

const paginateSearchJobs = createPaginator(MediaConvertClient, SearchJobsCommand, "NextToken", "NextToken", "MaxResults");
...
const Ac4DynamicRangeCompressionDrcProfile = {
    FILM_LIGHT: "FILM_LIGHT",
    FILM_STANDARD: "FILM_STANDARD",
    MUSIC_LIGHT: "MUSIC_LIGHT",
    MUSIC_STANDARD: "MUSIC_STANDARD",
...
const MxfUncompressedAudioWrapping = {
    AES3: "AES3",
    AUTO: "AUTO",
};
...
const H264ExplicitWeightedPrediction = {
    DISABLED: "DISABLED",
    ENABLED: "ENABLED",
};
...
const DolbyVisionCompatibility = {
...
exports.Ac4BitstreamMode = Ac4BitstreamMode;
exports.Ac4CodingMode = Ac4CodingMode;
exports.Ac4DynamicRangeCompressionDrcProfile = Ac4DynamicRangeCompressionDrcProfile;
exports.Ac4Settings$ = Ac4Settings$;
exports.Ac4StereoDownmix = Ac4StereoDownmix;
...
exports.CmafImageBasedTrickPlayVariant$ = CmafImageBasedTrickPlayVariant$;
...
exports.CmfcC2paManifest = CmfcC2paManifest;
...
exports.ContentLightLevel$ = ContentLightLevel$;
...
exports.DashIsoImageBasedTrickPlayVariant$ = DashIsoImageBasedTrickPlayVariant$;
...
exports.ElementalInferenceConfiguration$ = ElementalInferenceConfiguration$;
exports.ElementalInferenceFeature = ElementalInferenceFeature;
exports.ElementalInferenceFeed$ = ElementalInferenceFeed$;
...
exports.H264ExplicitWeightedPrediction = H264ExplicitWeightedPrediction;
...
exports.HlsImageBasedTrickPlayVariant$ = HlsImageBasedTrickPlayVariant$;
...
exports.MasteringDisplayColorVolume$ = MasteringDisplayColorVolume$;
...
exports.MultiViewInput$ = MultiViewInput$;
exports.MultiViewSettings$ = MultiViewSettings$;
