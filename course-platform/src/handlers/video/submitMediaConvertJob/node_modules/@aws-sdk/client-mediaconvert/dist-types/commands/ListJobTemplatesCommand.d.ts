...
declare const ListJobTemplatesCommand_base: {
    new (input: ListJobTemplatesCommandInput): import("@smithy/core/client").CommandImpl<ListJobTemplatesCommandInput, ListJobTemplatesCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListJobTemplatesCommandInput]): import("@smithy/core/client").CommandImpl<ListJobTemplatesCommandInput, ListJobTemplatesCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
