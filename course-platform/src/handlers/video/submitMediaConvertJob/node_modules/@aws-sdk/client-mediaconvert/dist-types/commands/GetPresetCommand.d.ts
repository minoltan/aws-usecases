...
declare const GetPresetCommand_base: {
    new (input: GetPresetCommandInput): import("@smithy/core/client").CommandImpl<GetPresetCommandInput, GetPresetCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPresetCommandInput): import("@smithy/core/client").CommandImpl<GetPresetCommandInput, GetPresetCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
