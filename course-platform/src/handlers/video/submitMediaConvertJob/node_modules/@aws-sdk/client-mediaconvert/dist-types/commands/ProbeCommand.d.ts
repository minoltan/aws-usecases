...
declare const ProbeCommand_base: {
    new (input: ProbeCommandInput): import("@smithy/core/client").CommandImpl<ProbeCommandInput, ProbeCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ProbeCommandInput]): import("@smithy/core/client").CommandImpl<ProbeCommandInput, ProbeCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
