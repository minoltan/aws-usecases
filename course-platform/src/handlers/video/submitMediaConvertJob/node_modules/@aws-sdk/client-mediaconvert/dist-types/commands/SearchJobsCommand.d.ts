...
declare const SearchJobsCommand_base: {
    new (input: SearchJobsCommandInput): import("@smithy/core/client").CommandImpl<SearchJobsCommandInput, SearchJobsCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [SearchJobsCommandInput]): import("@smithy/core/client").CommandImpl<SearchJobsCommandInput, SearchJobsCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
