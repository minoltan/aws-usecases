...
declare const CreateJobTemplateCommand_base: {
    new (input: CreateJobTemplateCommandInput): import("@smithy/core/client").CommandImpl<CreateJobTemplateCommandInput, CreateJobTemplateCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateJobTemplateCommandInput): import("@smithy/core/client").CommandImpl<CreateJobTemplateCommandInput, CreateJobTemplateCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
