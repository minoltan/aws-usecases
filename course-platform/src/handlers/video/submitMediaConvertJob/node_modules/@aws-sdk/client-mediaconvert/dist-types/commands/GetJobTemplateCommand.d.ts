...
declare const GetJobTemplateCommand_base: {
    new (input: GetJobTemplateCommandInput): import("@smithy/core/client").CommandImpl<GetJobTemplateCommandInput, GetJobTemplateCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetJobTemplateCommandInput): import("@smithy/core/client").CommandImpl<GetJobTemplateCommandInput, GetJobTemplateCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
