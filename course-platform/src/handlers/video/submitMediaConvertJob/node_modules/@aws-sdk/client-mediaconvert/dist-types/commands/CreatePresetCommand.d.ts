...
declare const CreatePresetCommand_base: {
    new (input: CreatePresetCommandInput): import("@smithy/core/client").CommandImpl<CreatePresetCommandInput, CreatePresetCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePresetCommandInput): import("@smithy/core/client").CommandImpl<CreatePresetCommandInput, CreatePresetCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
