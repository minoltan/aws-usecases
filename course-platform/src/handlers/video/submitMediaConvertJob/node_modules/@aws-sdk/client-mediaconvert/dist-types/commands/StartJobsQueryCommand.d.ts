...
declare const StartJobsQueryCommand_base: {
    new (input: StartJobsQueryCommandInput): import("@smithy/core/client").CommandImpl<StartJobsQueryCommandInput, StartJobsQueryCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [StartJobsQueryCommandInput]): import("@smithy/core/client").CommandImpl<StartJobsQueryCommandInput, StartJobsQueryCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
