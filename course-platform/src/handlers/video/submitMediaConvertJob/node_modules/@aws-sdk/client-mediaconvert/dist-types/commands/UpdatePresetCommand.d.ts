...
declare const UpdatePresetCommand_base: {
    new (input: UpdatePresetCommandInput): import("@smithy/core/client").CommandImpl<UpdatePresetCommandInput, UpdatePresetCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePresetCommandInput): import("@smithy/core/client").CommandImpl<UpdatePresetCommandInput, UpdatePresetCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
