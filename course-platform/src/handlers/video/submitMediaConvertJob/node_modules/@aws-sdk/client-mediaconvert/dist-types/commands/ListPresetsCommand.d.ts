...
declare const ListPresetsCommand_base: {
    new (input: ListPresetsCommandInput): import("@smithy/core/client").CommandImpl<ListPresetsCommandInput, ListPresetsCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListPresetsCommandInput]): import("@smithy/core/client").CommandImpl<ListPresetsCommandInput, ListPresetsCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
