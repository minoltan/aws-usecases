...
declare const ListActivitiesCommand_base: {
    new (input: ListActivitiesCommandInput): import("@smithy/core/client").CommandImpl<ListActivitiesCommandInput, ListActivitiesCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListActivitiesCommandInput]): import("@smithy/core/client").CommandImpl<ListActivitiesCommandInput, ListActivitiesCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
