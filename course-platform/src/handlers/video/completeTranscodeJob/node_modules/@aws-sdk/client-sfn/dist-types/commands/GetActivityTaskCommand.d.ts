...
declare const GetActivityTaskCommand_base: {
    new (input: GetActivityTaskCommandInput): import("@smithy/core/client").CommandImpl<GetActivityTaskCommandInput, GetActivityTaskCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetActivityTaskCommandInput): import("@smithy/core/client").CommandImpl<GetActivityTaskCommandInput, GetActivityTaskCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
