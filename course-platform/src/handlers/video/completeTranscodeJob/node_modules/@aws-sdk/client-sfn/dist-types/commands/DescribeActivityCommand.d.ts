...
declare const DescribeActivityCommand_base: {
    new (input: DescribeActivityCommandInput): import("@smithy/core/client").CommandImpl<DescribeActivityCommandInput, DescribeActivityCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeActivityCommandInput): import("@smithy/core/client").CommandImpl<DescribeActivityCommandInput, DescribeActivityCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
