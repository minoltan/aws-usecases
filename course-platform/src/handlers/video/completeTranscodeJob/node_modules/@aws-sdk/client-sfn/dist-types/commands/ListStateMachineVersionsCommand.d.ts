...
declare const ListStateMachineVersionsCommand_base: {
    new (input: ListStateMachineVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListStateMachineVersionsCommandInput, ListStateMachineVersionsCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListStateMachineVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListStateMachineVersionsCommandInput, ListStateMachineVersionsCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
