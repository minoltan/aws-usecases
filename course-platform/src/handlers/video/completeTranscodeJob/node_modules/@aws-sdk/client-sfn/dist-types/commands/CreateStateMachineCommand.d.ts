...
declare const CreateStateMachineCommand_base: {
    new (input: CreateStateMachineCommandInput): import("@smithy/core/client").CommandImpl<CreateStateMachineCommandInput, CreateStateMachineCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateStateMachineCommandInput): import("@smithy/core/client").CommandImpl<CreateStateMachineCommandInput, CreateStateMachineCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
