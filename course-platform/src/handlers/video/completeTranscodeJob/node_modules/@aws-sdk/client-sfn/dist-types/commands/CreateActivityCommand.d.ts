...
declare const CreateActivityCommand_base: {
    new (input: CreateActivityCommandInput): import("@smithy/core/client").CommandImpl<CreateActivityCommandInput, CreateActivityCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateActivityCommandInput): import("@smithy/core/client").CommandImpl<CreateActivityCommandInput, CreateActivityCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
