...
declare const DescribeMapRunCommand_base: {
    new (input: DescribeMapRunCommandInput): import("@smithy/core/client").CommandImpl<DescribeMapRunCommandInput, DescribeMapRunCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeMapRunCommandInput): import("@smithy/core/client").CommandImpl<DescribeMapRunCommandInput, DescribeMapRunCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
