...
declare const DescribeStateMachineForExecutionCommand_base: {
    new (input: DescribeStateMachineForExecutionCommandInput): import("@smithy/core/client").CommandImpl<DescribeStateMachineForExecutionCommandInput, DescribeStateMachineForExecutionCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeStateMachineForExecutionCommandInput): import("@smithy/core/client").CommandImpl<DescribeStateMachineForExecutionCommandInput, DescribeStateMachineForExecutionCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
