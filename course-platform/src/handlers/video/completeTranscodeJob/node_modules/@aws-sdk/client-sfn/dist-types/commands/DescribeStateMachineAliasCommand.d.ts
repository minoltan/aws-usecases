...
declare const DescribeStateMachineAliasCommand_base: {
    new (input: DescribeStateMachineAliasCommandInput): import("@smithy/core/client").CommandImpl<DescribeStateMachineAliasCommandInput, DescribeStateMachineAliasCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeStateMachineAliasCommandInput): import("@smithy/core/client").CommandImpl<DescribeStateMachineAliasCommandInput, DescribeStateMachineAliasCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
