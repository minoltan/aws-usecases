...
declare const DeleteStateMachineCommand_base: {
    new (input: DeleteStateMachineCommandInput): import("@smithy/core/client").CommandImpl<DeleteStateMachineCommandInput, DeleteStateMachineCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteStateMachineCommandInput): import("@smithy/core/client").CommandImpl<DeleteStateMachineCommandInput, DeleteStateMachineCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
