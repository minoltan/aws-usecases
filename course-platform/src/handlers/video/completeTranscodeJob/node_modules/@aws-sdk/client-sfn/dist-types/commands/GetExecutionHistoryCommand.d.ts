...
declare const GetExecutionHistoryCommand_base: {
    new (input: GetExecutionHistoryCommandInput): import("@smithy/core/client").CommandImpl<GetExecutionHistoryCommandInput, GetExecutionHistoryCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetExecutionHistoryCommandInput): import("@smithy/core/client").CommandImpl<GetExecutionHistoryCommandInput, GetExecutionHistoryCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
