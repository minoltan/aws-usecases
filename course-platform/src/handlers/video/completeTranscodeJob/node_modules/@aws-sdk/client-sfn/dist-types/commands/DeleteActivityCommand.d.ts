...
declare const DeleteActivityCommand_base: {
    new (input: DeleteActivityCommandInput): import("@smithy/core/client").CommandImpl<DeleteActivityCommandInput, DeleteActivityCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteActivityCommandInput): import("@smithy/core/client").CommandImpl<DeleteActivityCommandInput, DeleteActivityCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
