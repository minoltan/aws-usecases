...
declare const CreateStateMachineAliasCommand_base: {
    new (input: CreateStateMachineAliasCommandInput): import("@smithy/core/client").CommandImpl<CreateStateMachineAliasCommandInput, CreateStateMachineAliasCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateStateMachineAliasCommandInput): import("@smithy/core/client").CommandImpl<CreateStateMachineAliasCommandInput, CreateStateMachineAliasCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
