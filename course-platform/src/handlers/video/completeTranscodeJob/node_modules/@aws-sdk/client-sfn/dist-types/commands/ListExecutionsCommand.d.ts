...
declare const ListExecutionsCommand_base: {
    new (input: ListExecutionsCommandInput): import("@smithy/core/client").CommandImpl<ListExecutionsCommandInput, ListExecutionsCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListExecutionsCommandInput]): import("@smithy/core/client").CommandImpl<ListExecutionsCommandInput, ListExecutionsCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
