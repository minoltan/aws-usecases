...
declare const ListMapRunsCommand_base: {
    new (input: ListMapRunsCommandInput): import("@smithy/core/client").CommandImpl<ListMapRunsCommandInput, ListMapRunsCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListMapRunsCommandInput): import("@smithy/core/client").CommandImpl<ListMapRunsCommandInput, ListMapRunsCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
