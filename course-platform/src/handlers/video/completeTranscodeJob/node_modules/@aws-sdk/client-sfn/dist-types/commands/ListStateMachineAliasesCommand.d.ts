...
declare const ListStateMachineAliasesCommand_base: {
    new (input: ListStateMachineAliasesCommandInput): import("@smithy/core/client").CommandImpl<ListStateMachineAliasesCommandInput, ListStateMachineAliasesCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListStateMachineAliasesCommandInput): import("@smithy/core/client").CommandImpl<ListStateMachineAliasesCommandInput, ListStateMachineAliasesCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
