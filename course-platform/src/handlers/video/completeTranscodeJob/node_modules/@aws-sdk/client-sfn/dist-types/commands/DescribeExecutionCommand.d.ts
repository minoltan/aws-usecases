...
declare const DescribeExecutionCommand_base: {
    new (input: DescribeExecutionCommandInput): import("@smithy/core/client").CommandImpl<DescribeExecutionCommandInput, DescribeExecutionCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeExecutionCommandInput): import("@smithy/core/client").CommandImpl<DescribeExecutionCommandInput, DescribeExecutionCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
