...
declare const DescribeStateMachineCommand_base: {
    new (input: DescribeStateMachineCommandInput): import("@smithy/core/client").CommandImpl<DescribeStateMachineCommandInput, DescribeStateMachineCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeStateMachineCommandInput): import("@smithy/core/client").CommandImpl<DescribeStateMachineCommandInput, DescribeStateMachineCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
