...
declare const DeleteStateMachineAliasCommand_base: {
    new (input: DeleteStateMachineAliasCommandInput): import("@smithy/core/client").CommandImpl<DeleteStateMachineAliasCommandInput, DeleteStateMachineAliasCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteStateMachineAliasCommandInput): import("@smithy/core/client").CommandImpl<DeleteStateMachineAliasCommandInput, DeleteStateMachineAliasCommandOutput, import("..").SFNClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
